...
map("<leader>hf", function() haunt_picker.show() end, "Show Picker")
map("<leader>hq", function() haunt.to_quickfix() end, "Send Hauntings to [Q]F Lix (all)")
map("<leader>hQ", function() haunt.to_quickfix({ current_buffer = true }) end, "Send Hauntings to [Q]F Lix (buffer)")
map("<leader>hl", function() haunt.yank_locations({ current_buffer = true }) end, "Send Hauntings to Clipboard (buffer)")
map("<leader>hL", function() haunt.yank_locations() end, "Send Hauntings to Clipboard (all)")
