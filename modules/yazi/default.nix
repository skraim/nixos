    ...
    keymap = {
      mgr = {
        ...
        keymap = [
          ...
          # Hopping
          { on = "a"; run = "arrow -1"; desc = "Move cursor up"; }
          { on = "h"; run = "arrow 1"; desc = "Move cursor down"; }
          ...
          { on = "E"; run = "forward"; desc = "Go forward to the next directory"; }

          # Seeking
          { on = "A"; run = "seek -5"; desc = "Seek up 5 units in the preview"; }
          { on = "H"; run = "seek 5"; desc = "Seek down 5 units in the preview"; }
          ...
          { on = "l"; run = "yank"; desc = "Yank selected files (copy)"; }
          ...
          { on = "L"; run = "unyank"; desc = "Cancel the yank status"; }
          { on = "X"; run = "unyank"; desc = "Cancel the yank status"; }
          { on = "d"; run = "remove"; desc = "Trash selected files"; }
          { on = "D"; run = "remove --permanently"; desc = "Permanently delete selected files"; }
          { on = "k"; run = "create"; desc = "Create a file (ends with / for directories)"; }
      ...
      input = {
        keymap = [
          ...
          { on = "k"; run = "insert --append"; desc = "Enter append mode"; }
          { on = "I"; run = [ "move -999" "insert" ]; desc = "Move to the BOL, and enter insert mode"; }
          { on = "K"; run = [ "move 999" "insert --append" ]; desc = "Move to the EOL, and enter append mode"; }
          ...
          { on = "l"; run = "yank"; desc = "Copy the selected characters"; }
      ...
      completion = {
        keymap = [
          ...
          { on = "<A-a>"; run = "arrow -1"; desc = "Move cursor up"; }
          { on = "<A-h>"; run = "arrow 1"; desc = "Move cursor down"; }
      ...
      help = {
        keymap = [
          ...
          { on = "<C-c>"; run = "escape"; desc = "Clear the filter, or hide the help"; }
      ...
      spot = {
        keymap = [
          { on = "a"; run = "arrow prev"; desc = "Previous line"; }
          { on = "h"; run = "arrow next"; desc = "Next line"; }
      ...
      pick = {
        keymap = [
          { on = "a"; run = "arrow prev"; desc = "Previous option"; }
          { on = "h"; run = "arrow next"; desc = "Next option"; }
        ];
      };
    };
    settings = {
